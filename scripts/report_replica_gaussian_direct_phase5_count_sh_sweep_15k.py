...
EXPERIMENTS = [
    {"label": "baseline", "group": "reference", "experiment_name": "gaussian_direct_surface_rgb_baseline_15000"},
    {"label": "prior_full", "group": "reference", "experiment_name": "gaussian_direct_surface_rgb_prior_full_15000"},
    {"label": "prior_100k", "group": "reference", "experiment_name": "gaussian_direct_surface_rgb_prior_100k_15000"},
    {"label": "prior_25k", "group": "reference", "experiment_name": "gaussian_direct_surface_rgb_prior_25k_15000"},
    {
        "label": "prior_25k_full_none",
        "group": "reference",
        "experiment_name": "gaussian_direct_surface_rgb_prior_25k_full_none_15000",
    },
    {"label": "prior_50k", "group": "phase5_2", "experiment_name": "gaussian_direct_surface_rgb_prior_50k_15000"},
    {"label": "prior_75k", "group": "phase5_2", "experiment_name": "gaussian_direct_surface_rgb_prior_75k_15000"},
    {
        "label": "prior_100k_geo",
        "group": "phase5_2",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Report Phase 5.2 15K count/SH sweep.")
            ...
            summary_rows.append(
                {
                    ...
                    "iter_15000_psnr": iter_final.get("psnr"),
                    "iter_15000_ssim": iter_final.get("ssim"),
                    "iter_15000_lpips": iter_final.get("lpips"),
                    "iter_15000_gaussians": iter_final.get("gaussian_count"),
                    ...
                    "prior_survived_15000": prior_survived_final if selected_priors else None,
                ...
                object_rows.append(
                    {
                        ...
                        "survived_15000": gfinal.get("survived_point_count"),
                        "survival_ratio_15000": gfinal.get("survival_ratio"),
                    }
                )
    ...
    summary_csv = build_dated_report_csv_path(
        reports_dir.parent,
        slug="phase5_count_sh_sweep_15k",
        kind="summary",
        when=report_date,
    )
    ...
    report_path = build_dated_doc_path(
        ROOT,
