...
FAMILIES = {
    "object_centric_dense_384": {
        "label": "Object-centric dense 384-view",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Write the Replica gaussian-direct Phase 2 room-wide report.")
    ...
    lines = [
        ...
        "- 비교 범위: object-centric dense 384-view vs legacy biased room-wide 384-view",
        "- protection 비교: `none`, `weak(0.02)`",
        "",
        "## Object-Centric Dense 384",
        "",
        markdown_table(summary, "object_centric_dense_384"),
        "",
        "## Room-Wide 384",
        "",
        markdown_table(summary, "roomwide_384"),
        "",
        "## Artifact",
        "",
