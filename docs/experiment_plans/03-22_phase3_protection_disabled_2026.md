...
- `docs/experiment_plans/03-22_interference_mitigation_combinations_2026.md` (간섭 완화 조합)
...
상세 수치:
- `docs/experiment_results/03-22_interference_diagnosis_room_0_2026.md`
- `docs/experiment_results/03-22_interference_combinations_room_0_2026.md`
